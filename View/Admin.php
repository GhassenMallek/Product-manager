                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo"><a href="index.php">BodySmart</a></div>
                            <nav class="main_nav">
                                <ul>
...
<div class="champAyman" >
        <div style="color:white">        
			...
			if (isset($_SESSION['passwordAdmin']) && isset($_SESSION['emailAdmin'])) {
				$res = $us->listClient();
			?>
               <div class="client" style="display: inline-block;float: left;">
                    <div><h2>Clients</h2></div>
                <table border='1' style="display: inline-block;color:white;">
                <tr><td>First Name</td>
                <td>Last Name</td>
                <td>Email</td>
                <td>Password</td>
                ...
                <?php
					foreach ($res as $row) {
						...
						echo "<td>$row[3]</td>";
						echo "<td>$row[4]</td>";
						echo "<td><a href ='ProfAdmin.php?id=$row[0]'>Modifier</a></td><td>";
						if ($a->RechAdmin($row[3])->fetchColumn(0) == 0) {
							echo "<a href ='../Controler/makeAdmin.php?email=$row[3]&password=$row[4]'>Make Admin</a>";
						}
                            echo "</td><td><a href='../Controler/sup.php?id=$row[0]'>Supprimer</a></td> </tr>";
						}
						echo "</table></div>";
               ...
               <div class="client" style="display: inline-block;float: left;">
                ...
                <?php
					foreach ($res as $row) {
						...
						echo "<td>$row[2]</td>";
                        echo "<td>$row[3]</td>";
                        echo "<td><img width='40' height='40' src='$row[4]'/></td>";
						echo "<td><a href ='modifProd.php?id=$row[0]'>Modifier</a></td>";
							echo "<td><a href='../Controler/supProd.php?id=$row[0]'>Supprimer</a></td> </tr>";
						}
						echo "</table><br/><a href='prod.php'><button>ajouter Produit</button></a></div>";
