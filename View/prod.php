...
include_once "..\Model\Class\Product.class.php";
 session_start(); if(!((isset($_SESSION["emailAdmin"]) && isset($_SESSION["passwordAdmin"])))){
...
<div class="home">
	<div class="champAyman" >
		<div class="formAyman">	
			...
			<table>
                <form method="POST" action="..\Controler\traitprod.php">
                    <tr>
                        <td>Desigation</td><td ><input type="text"name="Desigation" class="login"/></td>
                    </tr>
                	<tr>
                    	<td>Prix</td><td><input type="text" name="Prix" class="login"/></td>
                	</tr>
                	<tr>
                		<td>Caracteristique</td><td ><input type="text"name="Caracteristique" class="login"/></td>
                	</tr>
                	<tr>
                    	<td>Image</td><td><input type="file" name="Image" class="login"/></td>
                    </tr>
