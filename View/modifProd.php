	...
	<div class="champAyman" >
		<div class="formAyman">		
            ...
            <?php 
                ...
                $e=new produit();
                $id=$_GET['id'];
                $res=$e->Rechproduit($id);
                $row=$res->fetch();
            ?>										
			<table>
                <form method="POST" action="..\Controler\ModifProd.php">
                <input hidden type="text" name="id" class="login" value="<?php echo $row[0] ?>"/>
                    <tr>
                        <td>Designation</td><td><input type="text" name="Designation" class="login" value="<?php echo $row[1] ?>"/></td>
                    </tr>
                    <tr>
                        <td>Prix</td><td><input type="text" name="Prix" class="login" value="<?php echo $row[2] ?>"/></td>
                    </tr>
                    <tr>
                        <td>Caracteristique</td><td ><input type="text"name="Caracteristique" class="login" value="<?php echo $row[3] ?>"/></td>
                    </tr>
                	<tr>
                    	<td>Image</td><td><input type="file" name="Image" class="login" value="<?php echo $row[4]?>"/></td>
                	</tr>
                	<tr>
