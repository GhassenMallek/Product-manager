		...
		<div class="formAyman">		
			...
			<table>
                <form method="POST" action="..\Controler\trait.php">
                    ...
                    <tr>
                		<td>Centre d'interet</td><td><select name="Centre[]" class="login" multiple><option>Protein</option><option>WeightLifting</option><option>BodyBuilding</option></select></td>
                	</tr>
                	<tr>
