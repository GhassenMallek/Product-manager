							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">BodySmart</div>
										<div class="home_slider_subtitle">Train your body in a smart way with us .</div>
										<div class="button button_light home_button"><a href="listProd.php">Shop Now</a></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="avds_discount_container">
						...
						<div>
							<div class="avds_discount">
								<div>buy 1<span> get 1</span></div>
								<div>For Free</div>
							</div>
						</div>
					</div>
					<div class="avds_small_content">
						<div class="avds_title">Lifting weights</div>
						<div class="avds_link"><a href="listProd.php">See More</a></div>
					</div>
				</div>
			</div>
			<div class="avds_large">
				...
				<div class="avds_large_container">
					<div class="avds_large_content">
						<div class="avds_title">Proteins</div>
						<div class="avds_text">Get your nutrition compliments for free for each check out you do !!!!</div>
						<div class="avds_link avds_link_large"><a href="listProd.php">See More</a></div>
					</div>
				</div>
			</div>
		</div>
